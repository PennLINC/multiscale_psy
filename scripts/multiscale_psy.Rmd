...
bwdf<-data.frame(tmvec,scalesvec,domnetvec,domnetvec17,netpropvec,avg_bw_deltaR2_OV,avg_bw_deltaP_OV,avg_bw_deltaR2_FE,avg_bw_deltaP_FE,avg_bw_deltaR2_AM,avg_bw_deltaP_AM,avg_bw_deltaR2_PS,avg_bw_deltaP_PS,avg_bw_deltaR2_EX,avg_bw_deltaP_EX,avg_bw_deltaR2_age,avg_bw_deltaP_age,occvec)
```

```{r}
# transient chunk
SplineP_fdr<-p.adjust(avg_bw_deltaP_age,method='fdr')
...
# stats for fig-lm
Age_net_lm<-lm(avg_bw_deltaR2_age~tmvec,data=bwdf)
cor.test(bwdf$tmvec,bwdf$avg_bw_deltaR2_age,method='spearman')
```
