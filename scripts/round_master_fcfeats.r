...
library(vroom)
fc<-vroom('/cbica/projects/pinesParcels/results_psy/aggregated_data/fc/master_fcfeats_psy.csv')
...
write.csv(fc,'/cbica/projects/pinesParcels/results_psy/aggregated_data/fc/master_fcfeats_psy_rounded.csv')
