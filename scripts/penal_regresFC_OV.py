...
filename='/cbica/projects/pinesParcels/results_psy/EffectVecs/AgeMotOV'
...
allPredsFN='/cbica/projects/pinesParcels/data_psy/aggregated_data/Predicted_Obs_Cors.csv'
np.savetxt(allPredsFN,all_preds,delimiter=",")
# mean MSE
meanMSE=np.average(mse_AI[:,0])
print("Mean Mean Squared Error (unpermuted):" + str(meanMSE))
featureweightsFN='/cbica/projects/pinesParcels/data_psy/aggregated_data/FeatureWeights_AI.csv'
np.savetxt(featureweightsFN,mean_featureWeights_AI,delimiter=",")
# save predicted subject info
subjpredsFN='/cbica/projects/pinesParcels/data_psy/aggregated_data/SubjPreds_AI.csv'
np.savetxt(subjpredsFN,subject_preds_AI,delimiter=",")
# save permuted predictions vector
permpredsFN='/cbica/projects/pinesParcels/data_psy/aggregated_data/PermutPreds_AI.csv'
